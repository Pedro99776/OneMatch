    ...
    <div className="min-h-dvh flex bg-[#0a0a0f] relative overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 max-w-md text-center animate-fade-in-up">
          <div className="w-24 h-24 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-[0_0_40px_rgba(236,72,153,0.4)] overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-6 pb-12">
          <div className="w-full max-w-sm animate-fade-in-up">
            ...
            <div className="text-center mb-8 lg:text-left">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto lg:mx-0 mb-5 glow-red lg:hidden overflow-hidden shadow-lg border border-purple-500/20">
                <img src="/logo.jpg" alt="OneMatch Logo" className="w-full h-full object-cover" />
              </div>
